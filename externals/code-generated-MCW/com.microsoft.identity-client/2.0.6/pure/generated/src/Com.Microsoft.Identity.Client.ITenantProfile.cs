...
namespace Com.Microsoft.Identity.Client {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.microsoft.identity.client']/interface[@name='ITenantProfile']"
	[Register ("com/microsoft/identity/client/ITenantProfile", "", "Com.Microsoft.Identity.Client.ITenantProfileInvoker")]
	public partial interface ITenantProfile : global::Com.Microsoft.Identity.Client.IAccount {
	}

	[global::Android.Runtime.Register ("com/microsoft/identity/client/ITenantProfile", DoNotGenerateAcw=true)]
	internal partial class ITenantProfileInvoker : global::Java.Lang.Object, ITenantProfile {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/microsoft/identity/client/ITenantProfile", typeof (ITenantProfileInvoker));
		...
		public static ITenantProfile GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<ITenantProfile> (handle, transfer);
		}

		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.", JNIEnv.GetClassNameFromInstance (handle), "com.microsoft.identity.client.ITenantProfile"));
			return handle;
		}
		...
		public ITenantProfileInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Microsoft.Identity.Client.ITenantProfile> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
