...
namespace Com.Microsoft.Identity.Client {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.microsoft.identity.client']/interface[@name='IMultiTenantAccount']"
	[Register ("com/microsoft/identity/client/IMultiTenantAccount", "", "Com.Microsoft.Identity.Client.IMultiTenantAccountInvoker")]
	public partial interface IMultiTenantAccount : global::Com.Microsoft.Identity.Client.IAccount {
		global::System.Collections.Generic.IDictionary<string, global::Com.Microsoft.Identity.Client.ITenantProfile> TenantProfiles {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.microsoft.identity.client']/interface[@name='IMultiTenantAccount']/method[@name='getTenantProfiles' and count(parameter)=0]"
			[Register ("getTenantProfiles", "()Ljava/util/Map;", "GetGetTenantProfilesHandler:Com.Microsoft.Identity.Client.IMultiTenantAccountInvoker, Microsoft.Identity.Client")]
			get; 
		}

	}

	[global::Android.Runtime.Register ("com/microsoft/identity/client/IMultiTenantAccount", DoNotGenerateAcw=true)]
	internal partial class IMultiTenantAccountInvoker : global::Java.Lang.Object, IMultiTenantAccount {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/microsoft/identity/client/IMultiTenantAccount", typeof (IMultiTenantAccountInvoker));
		...
		public static IMultiTenantAccount GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IMultiTenantAccount> (handle, transfer);
		}

		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.", JNIEnv.GetClassNameFromInstance (handle), "com.microsoft.identity.client.IMultiTenantAccount"));
			return handle;
		}
		...
		public IMultiTenantAccountInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Microsoft.Identity.Client.IMultiTenantAccount> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		IntPtr id_getTenantProfiles;
		public unsafe global::System.Collections.Generic.IDictionary<string, global::Com.Microsoft.Identity.Client.ITenantProfile> TenantProfiles {
			get {
				if (id_getTenantProfiles == IntPtr.Zero)
					id_getTenantProfiles = JNIEnv.GetMethodID (class_ref, "getTenantProfiles", "()Ljava/util/Map;");
				return global::Android.Runtime.JavaDictionary<string, global::Com.Microsoft.Identity.Client.ITenantProfile>.FromJniHandle (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getTenantProfiles), JniHandleOwnership.TransferLocalRef);
			}
		}
