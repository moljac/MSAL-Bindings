...
namespace Com.Microsoft.Identity.Common.Internal.Commands {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.microsoft.identity.common.internal.commands']/interface[@name='CommandCallback']"
	[Register ("com/microsoft/identity/common/internal/commands/CommandCallback", "", "Com.Microsoft.Identity.Common.Internal.Commands.ICommandCallbackInvoker")]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T", "U"})]
	public partial interface ICommandCallback : global::Com.Microsoft.Identity.Common.Internal.Controllers.ITaskCompletedCallbackWithError {
		// Metadata.xml XPath method reference: path="/api/package[@name='com.microsoft.identity.common.internal.commands']/interface[@name='CommandCallback']/method[@name='onCancel' and count(parameter)=0]"
		[Register ("onCancel", "()V", "GetOnCancelHandler:Com.Microsoft.Identity.Common.Internal.Commands.ICommandCallbackInvoker, Microsoft.Identity.Common")]
		void OnCancel ();

	}

	[global::Android.Runtime.Register ("com/microsoft/identity/common/internal/commands/CommandCallback", DoNotGenerateAcw=true)]
	internal partial class ICommandCallbackInvoker : global::Java.Lang.Object, ICommandCallback {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/microsoft/identity/common/internal/commands/CommandCallback", typeof (ICommandCallbackInvoker));
		...
		public static ICommandCallback GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<ICommandCallback> (handle, transfer);
		}

		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.", JNIEnv.GetClassNameFromInstance (handle), "com.microsoft.identity.common.internal.commands.CommandCallback"));
			return handle;
		}
		...
		public ICommandCallbackInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Microsoft.Identity.Common.Internal.Commands.ICommandCallback> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.OnCancel ();
		}
