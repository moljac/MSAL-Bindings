...
namespace Com.Microsoft.Identity.Common.Internal.Broker.Ipc {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.microsoft.identity.common.internal.broker.ipc']/class[@name='BoundServiceStrategy']"
	[global::Android.Runtime.Register ("com/microsoft/identity/common/internal/broker/ipc/BoundServiceStrategy", DoNotGenerateAcw=true)]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T extends android.os.IInterface"})]
	public partial class BoundServiceStrategy : global::Java.Lang.Object, global::Com.Microsoft.Identity.Common.Internal.Broker.Ipc.IIpcStrategy {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/microsoft/identity/common/internal/broker/ipc/BoundServiceStrategy", typeof (BoundServiceStrategy));
		...
		protected BoundServiceStrategy (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.microsoft.identity.common.internal.broker.ipc']/class[@name='BoundServiceStrategy']/constructor[@name='BoundServiceStrategy' and count(parameter)=1 and parameter[1][@type='com.microsoft.identity.common.internal.broker.BoundServiceClient&lt;T&gt;']]"
		[Register (".ctor", "(Lcom/microsoft/identity/common/internal/broker/BoundServiceClient;)V", "")]
		public unsafe BoundServiceStrategy (global::Com.Microsoft.Identity.Common.Internal.Broker.BoundServiceClient boundServiceClient) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "(Lcom/microsoft/identity/common/internal/broker/BoundServiceClient;)V";
			...
			try {
				...
				__args [0] = new JniArgumentValue ((boundServiceClient == null) ? IntPtr.Zero : ((global::Java.Lang.Object) boundServiceClient).Handle);
				var __r = _members.InstanceMethods.StartCreateInstance (__id, ((object) this).GetType (), __args);
				SetHandle (__r.Handle, JniHandleOwnership.TransferLocalRef);
				_members.InstanceMethods.FinishCreateInstance (__id, this, __args);
			} finally {
				global::System.GC.KeepAlive (boundServiceClient);
			}
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Microsoft.Identity.Common.Internal.Broker.Ipc.BoundServiceStrategy> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.Type);
		}
#pragma warning restore 0169

		public virtual unsafe global::Com.Microsoft.Identity.Common.Internal.Broker.Ipc.IpcStrategyType Type {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.microsoft.identity.common.internal.broker.ipc']/class[@name='BoundServiceStrategy']/method[@name='getType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.microsoft.identity.common.internal.broker.ipc']/class[@name='BoundServiceStrategy']/method[@name='communicateToBroker' and count(parameter)=1 and parameter[1][@type='com.microsoft.identity.common.internal.broker.ipc.BrokerOperationBundle']]"
