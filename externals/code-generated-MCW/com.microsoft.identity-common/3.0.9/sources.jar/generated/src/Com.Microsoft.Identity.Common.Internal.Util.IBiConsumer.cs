...
namespace Com.Microsoft.Identity.Common.Internal.Util {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.microsoft.identity.common.internal.util']/interface[@name='BiConsumer']"
	[Register ("com/microsoft/identity/common/internal/util/BiConsumer", "", "Com.Microsoft.Identity.Common.Internal.Util.IBiConsumerInvoker")]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T", "U"})]
	public partial interface IBiConsumer : IJavaObject, IJavaPeerable {
		// Metadata.xml XPath method reference: path="/api/package[@name='com.microsoft.identity.common.internal.util']/interface[@name='BiConsumer']/method[@name='accept' and count(parameter)=2 and parameter[1][@type='T'] and parameter[2][@type='U']]"
		[Register ("accept", "(Ljava/lang/Object;Ljava/lang/Object;)V", "GetAccept_Ljava_lang_Object_Ljava_lang_Object_Handler:Com.Microsoft.Identity.Common.Internal.Util.IBiConsumerInvoker, Microsoft.Identity.Common")]
		void Accept (global::Java.Lang.Object p0, global::Java.Lang.Object p1);

	}

	[global::Android.Runtime.Register ("com/microsoft/identity/common/internal/util/BiConsumer", DoNotGenerateAcw=true)]
	internal partial class IBiConsumerInvoker : global::Java.Lang.Object, IBiConsumer {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/microsoft/identity/common/internal/util/BiConsumer", typeof (IBiConsumerInvoker));
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.", JNIEnv.GetClassNameFromInstance (handle), "com.microsoft.identity.common.internal.util.BiConsumer"));
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Microsoft.Identity.Common.Internal.Util.IBiConsumer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
