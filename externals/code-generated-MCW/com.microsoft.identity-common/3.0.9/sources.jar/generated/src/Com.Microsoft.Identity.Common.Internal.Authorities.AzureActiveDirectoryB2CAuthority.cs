...
namespace Com.Microsoft.Identity.Common.Internal.Authorities {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.microsoft.identity.common.internal.authorities']/class[@name='AzureActiveDirectoryB2CAuthority']"
	[global::Android.Runtime.Register ("com/microsoft/identity/common/internal/authorities/AzureActiveDirectoryB2CAuthority", DoNotGenerateAcw=true)]
	public partial class AzureActiveDirectoryB2CAuthority : global::Com.Microsoft.Identity.Common.Internal.Authorities.Authority {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/microsoft/identity/common/internal/authorities/AzureActiveDirectoryB2CAuthority", typeof (AzureActiveDirectoryB2CAuthority));
		...
		protected AzureActiveDirectoryB2CAuthority (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.microsoft.identity.common.internal.authorities']/class[@name='AzureActiveDirectoryB2CAuthority']/constructor[@name='AzureActiveDirectoryB2CAuthority' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public unsafe AzureActiveDirectoryB2CAuthority (string authorityUrl) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Microsoft.Identity.Common.Internal.Authorities.AzureActiveDirectoryB2CAuthority> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.AuthorityURL);
		}
#pragma warning restore 0169

		public override unsafe global::Java.Net.URL AuthorityURL {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.microsoft.identity.common.internal.authorities']/class[@name='AzureActiveDirectoryB2CAuthority']/method[@name='getAuthorityURL' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public override unsafe global::Android.Net.Uri AuthorityUri {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.microsoft.identity.common.internal.authorities']/class[@name='AzureActiveDirectoryB2CAuthority']/method[@name='getAuthorityUri' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.microsoft.identity.common.internal.authorities']/class[@name='AzureActiveDirectoryB2CAuthority']/method[@name='createOAuth2Strategy' and count(parameter)=1 and parameter[1][@type='com.microsoft.identity.common.internal.providers.oauth2.OAuth2StrategyParameters']]"
